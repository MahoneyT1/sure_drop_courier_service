...
const ServiceSection: React.FC = () => {
  ...
  return (
    <section className='w-full mt-5'>
      <div className='mb-8'>
        <h4 className='text-center text-2xl font-semibold text-gray-700 lg:text-5xl lg:p-5 background-effect'
          >Our delivery services
        </h4>
      </div>

      <div className='grid grid-cols-1 justify-items-center gap-y-5 md:grid-cols-2 md:gap-y-8 md:gap-x-0
         md:justify-items-center lg:grid-cols-3 xl:grid-cols-4'>
       
          <Card cardIcon={"fa-solid fa-truck bg-gradient-to-r from-primary to-green-500 text-transparent bg-clip-text moving-fast-3d"}
